...
* Create two postgres databases: `fortuneteller` and `fortuneTeller-test`
  * By default, running `npm test` will use `fortuneteller-test`, while regular development uses `fortuneTeller`
